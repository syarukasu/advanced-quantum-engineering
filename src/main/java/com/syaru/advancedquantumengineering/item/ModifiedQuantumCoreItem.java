...
public class ModifiedQuantumCoreItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable(
                "tooltip.advanced_quantum_engineering.modified_quantum_core.coprocessors",
                AQEConfig.getBaseCoprocessors()
        ).withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable("tooltip.advanced_quantum_engineering.modified_quantum_core.core")
                .withStyle(ChatFormatting.AQUA));

        tooltip.add(Component.translatable("tooltip.advanced_quantum_engineering.modified_quantum_core.description.1")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.advanced_quantum_engineering.modified_quantum_core.description.2")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.advanced_quantum_engineering.modified_quantum_core.description.3")
                .withStyle(ChatFormatting.GRAY));
    }
